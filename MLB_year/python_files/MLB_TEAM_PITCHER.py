...
if __name__ == '__main__':
        col_name = ["team", "league", "W", "L", "ERA", "G", "GS", "CG", "SHO", "SV", "SVO", "IP", "H", "R",
                     "ER", "HR", "HB", "BB", "SO", "WHIP", "AVG", "url"]
        col_specific = ["team", "url"]
        year_list = [2020, 2019, 2018, 2017, 2016, 2015, 2014, 2013, 2012, 2011, 2010]

        scenario_list = ["h","a", "d", "n", "vl", "vr", "sah", "sbh", "sti", "r0", "r1",
                         "r12", "r123", "ron","ron2", "risp", "risp2", "o0", "o1", "o2", "ac", "bc",
                         "ec", "2s", "fc"]

        url = "https://www.mlb.com/stats/team/"

        file_path = "/Users/leechilin/Desktop/python scrape/data_MLB_TEAM_PITCHER/"
